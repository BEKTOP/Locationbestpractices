...
import com.radioactiveyak.location_best_practices.MainActivity;
  ...
  protected void onHandleIntent(Intent intent) {
      ...
      if (cursor.moveToFirst()) {
          ...
          if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
              ...
              try {
                  Method deprecatedMethod = notification2.getClass().getMethod("setLatestEventInfo", Context.class, CharSequence.class, CharSequence.class, PendingIntent.class);
                  deprecatedMethod.invoke(notification2, contentIntent, tickerText, null, contentPendingIntent);
